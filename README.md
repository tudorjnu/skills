<p>
  <a href="https://github.com/tudorjnu/skills">
    <picture>
...
[![skills.sh](https://skills.sh/b/tudorjnu/skills)](https://skills.sh/tudorjnu/skills)

My agent skills that I use every day to do real engineering - not vibe coding. Forked from [Matt Pocock's skills](https://github.com/mattpocock/skills).
...
**skills.sh** copies editable skill files into your project, so you can hack on them and make them your own. Forked from [Matt Pocock's skills](https://github.com/mattpocock/skills).
...
Pick the skills you want, and which coding agents to install them on. **The installer lets you choose which skills to take, so make sure `setup-engineering-skills` is one of them.**
...
### 2. Run `/setup-engineering-skills`
...
- **[git-commit](./skills/engineering/git-commit/SKILL.md)**: Create a conventional commit from the actual diff, with intelligent staging and message generation.
