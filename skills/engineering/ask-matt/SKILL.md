...
- **`/git-commit`**: create a conventional commit from the actual diff, with intelligent staging and message generation. Reach for it when you have finished a unit of work and want the commit written for you.
