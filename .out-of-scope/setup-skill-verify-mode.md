# Verify/Check Mode for `setup-engineering-skills`

This project will not add a dedicated verify/check mode (or a separate verify skill) for `setup-engineering-skills`.
...
- #106: Feature request: verify/check mode for setup-engineering-skills
